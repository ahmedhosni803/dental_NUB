...
class UploadScreen extends StatefulWidget {
 final AppointmentProvider provider;
  const UploadScreen({super.key,required this.provider});
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  widget.provider.addImage(_image!);
                  Navigator.pushReplacementNamed(context, AppRouteName.healthHistory,arguments: widget.provider);
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color(0xFF1F5382),
